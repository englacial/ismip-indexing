...
- File indexing and caching for ISMIP6 datasets
...
# Source data location (public, anonymous read)
SOURCE_DATA_URL = "s3://us-west-2.opendata.source.coop/englacial/ismip6"
